...
public class RuleEngineClientProcessingException extends Exception {
    ...
    public RuleEngineClientProcessingException(String message) {
        super(message);
    }

    public RuleEngineClientProcessingException(String message, Throwable cause) {
        super(message, cause);
    }
}
